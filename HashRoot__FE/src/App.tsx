...
import InputFileDefinition from './pages/InputFileDefinitions/InputFileDefinitions';
...
import AddInputFileDefinition from './pages/InputFileDefinitions/AddInputFileDefinition';
import ChangeInputFileDefinition from './pages/InputFileDefinitions/ChangeInputFileDefinition';
...
const App = () => {
  ...
  <Routes>
   ...
   <Route path ='/Files/add' element={<AddFiles/>}/>
     ...
     <Route path="/InputFileDefinition/edit/:id" element={<ChangeInputFileDefinition />} />
