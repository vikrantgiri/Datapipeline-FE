    ...
    <div className="col-span-3">
      <div className="bg-white p-4 shadow rounded border space-y-4">
       <div className="flex items-center justify-between">
        ...
        {RenderSelect(selectLabel1, selectedValue1, onSelectChange1, selectOptions1)}

       
        {RenderSelect(selectLabel2, selectedValue2, onSelectChange2, selectOptions2)}
        {RenderSelect(selectLabel3, selectedValue3, onSelectChange3, selectOptions3)}
        {RenderSelect(selectLabel4, selectedValue4, onSelectChange4, selectOptions4)}
      </div>
    </div>
  );
};
