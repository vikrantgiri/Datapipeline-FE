...
export const PROTECTED_ROUTES = {
  ...
  SNOWFLAKE: '/snowflake',
  SNOWFLAKE_ADD: '/snowflake/add',
  SNOWFLAKE_CHANGE: '/snowflake/change',
  ...
  ACTIVITY_LOG_BY_SNOWFLAKE_SCRIPT: `/activity-log/${TRIGGER_ENTITIES.SNOWFLAKE}`,
  ACTIVITY_LOG_BY_SNOWFLAKE_SCRIPT_BY_ID: `/activity-log/${TRIGGER_ENTITIES.SNOWFLAKE}/:id`,INPUT_FILE_DOWNLOADS: '/input-file-definitions/downloads',
} as const
